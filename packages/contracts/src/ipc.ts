...
export interface LocalApi {
  ...
  gc: {
    ...
    ) => Promise<GcSessionActionResult>;
    setAgentMinActiveSessions: (
      input: GcSetAgentMinActiveSessionsInput,
    ) => Promise<GcSessionActionResult>;
    setAgentWakeMode: (input: GcSetAgentWakeModeInput) => Promise<GcSessionActionResult>;
    setAgentSessionMode: (input: GcSetAgentSessionModeInput) => Promise<GcSessionActionResult>;
    setCitySuspended: (input: GcSetCitySuspendedInput) => Promise<GcSessionActionResult>;
    setRigSuspended: (input: GcSetRigSuspendedInput) => Promise<GcSessionActionResult>;
  };
}

...
- building the library with SQLITE_ENABLE_SETLK_TIMEOUT defined, and
- configuring a timeout in ms using the sqlite3_busy_timeout() API.
...
returns SQLITE_BUSY to the user. With blocking locks configured, the second
...
from having to handle SQLITE_BUSY errors and facilitate appropriate transfer

...
2.  _(Optional):_ Install TCL development libraries. In this note,
...
3.  Download the SQLite source tree and unpack it. CD into the
    toplevel directory of the source tree.

4.  _(Optional):_ Download Antirez's "linenoise" command-line editing
...
6.  Run the "`Makefile`" makefile with an appropriate target.
    ...
    The version of SQLite used for the TCL extension does _not_ need to
...
7.  For a debugging build of the CLI, use `./configure --dev`. A debugging

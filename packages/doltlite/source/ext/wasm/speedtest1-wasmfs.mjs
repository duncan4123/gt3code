...
const wasmfsDir = function f(wasmUtil, dirName = "/opfs") {
  ...
  try {
    if (0 === wasmUtil.xCallWrapped("sqlite3__wasm_init_wasmfs", "i32", ["string"], dirName)) {
      return (f._ = dirName);
    } else {
      return (f._ = "");
    }
...
const runTests = function (sqlite3) {
  ...
  argv.push("--big-transactions" /*important for tests 410 and 510!*/, dbFile);
  //log("argv =",argv);
  ...
  log("This will take a while and the browser might warn about the runaway JS.", "Give it time...");
  setTimeout(function () {
    if (pDir) unlink(dbFile);

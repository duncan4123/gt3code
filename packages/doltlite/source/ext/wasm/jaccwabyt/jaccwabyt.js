...
*/
  ...
  */
   ...
   * descriptor. */
  const rop0 = () => {
    return { configurable: false, writable: false, iterable: false };
  };
    ...
    */
    ...
    prop.get = function () {
      ...
      */
      ...
      let rc = new DataView(heap().buffer, Number(this.pointer) + si.offset, si.sizeof)[
        f.cache.getters[sigGlyph]
      ](0, isLittleEndian);
      ...
      prop.set = function (v) {
        ...
        */
        ...
        new DataView(heap().buffer, Number(this.pointer) + si.offset, si.sizeof)[
          f.cache.setters[sigGlyph]
        ](0, f.cache.sw[sigGlyph](v), isLittleEndian);
      };
    }
    Object.defineProperty(ctor.prototype, key, prop);
  } /*makeMemberWrapper()*/;
    ...
    */
    ...
    Object.defineProperties(StructCtor.prototype, {
      ...
      /*if we assign StructCtor.prototype and don't do
        this then StructCtor!==instance.constructor*/ ptrAdd: rop(__ptrAddSelf),
    });
    ...
    Object.keys(si.members || {}).forEach((k) => {
      ...
      if (undefined === m.offset) {
        if (autoCalc) m.offset = offset;
          ...
          toss(sPropName(structName, k), "is missing its offset.", JSON.stringify(m));
        }

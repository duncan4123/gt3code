...
_This support is experimental and subject to change._
...
- `setMemberCString(memberName,str)`  
  ...
  _Achtung_: calling this repeatedly will not immediately free the
...
[^export-func]:
    In Emscripten, add its name, prefixed with `_`, to the

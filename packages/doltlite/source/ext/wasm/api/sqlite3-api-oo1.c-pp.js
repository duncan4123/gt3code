  ...
  const dbCtorHelper = function ctor(...args) {
    ...
    if (!opt["sqlite3*"]) {
      try {
        ...
        const pVfs =
          capi.sqlite3_js_db_vfs(pDb) || toss3("Internal error: cannot get VFS for new db handle.");
  ...
  DB.prototype = {
    ...
    */
    createFunction: function f(name, xFunc, opt) {
      ...
      const arityArg =
        "number" === typeof arity ? arity : xArity.length ? xArity.length - 1 /*for pCtx arg*/ : 0;
      let rc;
      if (isWindow) {
  ...
  Stmt.prototype = {
    ...
    */
    bind: function (/*[ndx,] arg*/) {
      ...
      if ("object" === typeof arg /*null was checked above*/ && !util.isBindableTypedArray(arg)) {

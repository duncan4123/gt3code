...
globalThis.sqlite3ApiBootstrap.initializers.push(function (sqlite3) {
    ...
    */
    int64: [
      ...
      /* Careful! Short version: de/serialize() are problematic because they
         ...
         may not guarantee that, however. */ ["sqlite3_last_insert_rowid", "i64", ["sqlite3*"]],
    ...
    */
    ...
    for (const e of bindingSignatures.int64) {
      capi[e[0]] = wasm.bigIntEnabled
        ...
        : () => toss(e[0] + "() is unavailable due to lack", "of BigInt support in this build.");
    }
  ...
  */
  ...
  const __dbCleanupMap = function (
    pDb,
    mode /*0=remove, >0=create if needed, <0=do not create if missing*/,
  ) {
    pDb = __argPDb(pDb);
    ...
    capi.sqlite3_prepare_v3 = function f(pDb, sql, sqlLen, prepFlags, ppStmt, pzTail) {
      ...
      switch (typeof xSql) {
        ...
        case typeof wasm.ptr.null:
          return __prepare.full(pDb, wasm.ptr.coerce(xSql), xSqlLen, prepFlags, ppStmt, pzTail);
        default:
          return util.sqlite3__wasm_db_error(
            pDb,
            capi.SQLITE_MISUSE,
  ...
  if (!capi.sqlite3_column_text) {
    ...
    */
    const argStmt = wasm.xWrap.argAdapter("sqlite3_stmt*"),
      ...
      newStr = (cstr, n) => wasm.typedArrayToString(wasm.heap8u(), Number(cstr), Number(cstr) + n);
...

  {
    ...
    capi.sqlite3_cancel_auto_extension = function (fPtr) {
      /* We do not do an automatic JS-to-WASM function conversion here
        ...
        never possibly match an already-installed one. */ if (
        !fPtr ||
        1 !== arguments.length ||
        !wasm.isPtr(fPtr)
      )

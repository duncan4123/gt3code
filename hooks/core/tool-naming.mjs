 ...
 * | Platform           | Pattern                                                    |
 * |--------------------|------------------------------------------------------------|
 * | Claude Code        | mcp__plugin_context-mode_context-mode-doltlite__<tool>      |
...
const TOOL_PREFIXES = {
  "claude-code":    (tool) => `mcp__plugin_context-mode_context-mode-doltlite__${tool}`,
  ...
  "jetbrains-copilot": (tool) => `context-mode-doltlite_${tool}`,
  ...
  "openclaw":       (tool) => tool,
  "pi":             (tool) => tool,
  "qwen-code":      (tool) => `mcp__context-mode-doltlite__${tool}`,
};

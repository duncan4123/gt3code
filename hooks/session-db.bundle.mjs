import{createRequire as S}from"node:module";import{unlinkSync as R,existsSync as l,mkdirSync as v,copyFileSync as f,statSync as _}from"node:fs";import{tmpdir as L}from"node:os";import{join as d,dirname as N}from"node:path";import{fileURLToPath as O}from"node:url";var E=null;function b(){if(!E){let n=S(import.meta.url);if(!globalThis.__DOLTLITE_NATIVE_PATH){let t=N(O(import.meta.url)),s=process.versions.modules,r=d(t,"prebuilds",`${process.platform}-${process.arch}`,`node.abi${s}.node`),i=d(t,"vendor","better-sqlite3","build","Release"),o=d(i,"better_sqlite3.node");if(l(r)){let a=!l(o);if(!a)try{_(r).size!==_(o).size&&(a=!0)}catch{a=!0}a&&(v(i,{recursive:!0}),f(r,o)),globalThis.__DOLTLITE_NATIVE_PATH=o}}try{E=n("./vendor/better-sqlite3")}catch(t){throw t}}return E}function D(n){try{n.prepare("SELECT doltlite_engine()").get();return}catch{}n.pragma("journal_mode = WAL"),n.pragma("synchronous = NORMAL")}function I(n){for(let t of["","-wal","-shm"])try{R(n+t)}catch{}}function T(n){try{(()=>{try{return n.prepare("SELECT doltlite_engine()").get(),!0}catch{return!1}})()||n.pragma("wal_checkpoint(TRUNCATE)")}catch{}try{n.close()}catch{}}function g(n="context-mode"){return d(L(),`${n}-${process.pid}.db`)}function C(n,t=[100,500,2e3]){let s;for(let r=0;r<=t.length;r++)try{return n()}catch(i){let o=i instanceof Error?i.message:String(i);if(!o.includes("SQLITE_BUSY")&&!o.includes("database is locked"))throw i;if(s=i instanceof Error?i:new Error(o),r<t.length){let a=t[r],p=Date.now();for(;Date.now()-p<a;);}}throw new Error(`SQLITE_BUSY: database is locked after ${t.length} retries. Original error: ${s?.message}`)}var c=Symbol.for("__context_mode_live_dbs__"),m=(()=>{let n=globalThis;return n[c]||(n[c]=new Set,process.on("exit",()=>{for(let t of n[c])try{t.close()}catch{}n[c].clear()})),n[c]})(),u=class{#e;#t;constructor(t){let s=b();this.#e=t,this.#t=new s(t,{timeout:3e4}),m.add(this.#t),D(this.#t),this.initSchema(),this.prepareStatements()}get db(){return this.#t}get dbPath(){return this.#e}close(){m.delete(this.#t),T(this.#t)}withRetry(t){return C(t)}cleanup(){m.delete(this.#t),T(this.#t),I(this.#e)}};import{createHash as y}from"node:crypto";import{execFileSync as A}from"node:child_process";function $(){let n=process.env.CONTEXT_MODE_SESSION_SUFFIX;if(n!==void 0)return n?`__${n}`:"";try{let t=process.cwd(),s=A("git",["worktree","list","--porcelain"],{encoding:"utf-8",timeout:2e3,stdio:["ignore","pipe","ignore"]}).split(/\r?\n/).find(r=>r.startsWith("worktree "))?.replace("worktree ","")?.trim();if(s&&t!==s)return`__${y("sha256").update(t).digest("hex").slice(0,8)}`}catch{}return""}var w=1e3,U=5,e={insertEvent:"insertEvent",getEvents:"getEvents",getEventsByType:"getEventsByType",getEventsByPriority:"getEventsByPriority",getEventsByTypeAndPriority:"getEventsByTypeAndPriority",getEventCount:"getEventCount",checkDuplicate:"checkDuplicate",evictLowestPriority:"evictLowestPriority",updateMetaLastEvent:"updateMetaLastEvent",ensureSession:"ensureSession",getSessionStats:"getSessionStats",incrementCompactCount:"incrementCompactCount",upsertResume:"upsertResume",getResume:"getResume",markResumeConsumed:"markResumeConsumed",deleteEvents:"deleteEvents",deleteMeta:"deleteMeta",deleteResume:"deleteResume",getOldSessions:"getOldSessions"},h=class extends u{constructor(t){super(t?.dbPath??g("session"))}stmt(t){return this.stmts.get(t)}initSchema(){try{let s=this.db.pragma("table_xinfo(session_events)").find(r=>r.name==="data_hash");s&&s.hidden!==0&&this.db.exec("DROP TABLE session_events")}catch{}this.db.exec(`

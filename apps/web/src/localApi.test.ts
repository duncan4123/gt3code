...
const rpcClientMock = {
  ...
  gc: {
    getConfig: vi.fn(),
    start: vi.fn(),
    setSupervisorRunning: vi.fn(),
    setControllerRunning: vi.fn(),
    findThreadBinding: vi.fn(),
    getThreadContext: vi.fn(),
    submitSession: vi.fn(),
    stopSession: vi.fn(),
    wakeSession: vi.fn(),
    respondToPending: vi.fn(),
    setAgentSuspended: vi.fn(),
    setAgentMaxActiveSessions: vi.fn(),
    setAgentMinActiveSessions: vi.fn(),
    setAgentWakeMode: vi.fn(),
    setAgentSessionMode: vi.fn(),
    setCitySuspended: vi.fn(),

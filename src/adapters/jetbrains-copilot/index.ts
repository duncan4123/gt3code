...
export class JetBrainsCopilotAdapter extends CopilotBaseAdapter {
  ...
  checkPluginRegistration(): DiagnosticResult {
    ...
    return {
      ...
      fix: "Verify in IDE: Settings > Tools > GitHub Copilot > MCP > ensure a context-mode-doltlite server entry exists",
    };
  }
  ...
  getInstalledVersion(): string {
    ...
    // written to .github/hooks/context-mode.json by `context-mode-doltlite upgrade`.
